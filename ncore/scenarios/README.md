...
- `project_civic_resilience_v5.yaml`: larger authoring scenario that combines
  v3 typed systems, v4 namespaced imports, and v5 `acme.market` plus
  `civic.resilience` extension lowering/expression symbols. The scenario imports population,
...
- `project_civic_resilience_experiment_v4_v5.yaml`: 16-run experiment over
  ...
  v5 extension metrics `acme.market::scaled_typed_field_final` and
